...
# Compute the average ratio of VALUE to Household Income while handling divisions by zero
value_to_income_ratio = median_house_values / median_household_incomes
value_to_income_ratio.replace([float('inf'), -float('inf')], None, inplace=True)  # Replace infinite values
